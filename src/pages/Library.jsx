  ...
  About: (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border-l-4 border-blue-500">
        ...
        <p className="text-gray-600 leading-relaxed">The college has a very spacious library hall with a big reading room. Our library houses a total of 2363 books, including Reference books, Curriculum Books, Encyclopedias, Text Books, and Novels. We also subscribe to National and International Journals and have newspapers, maps, and other educational materials available.</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-3 text-gray-600">Total Books</td>
                  <td className="p-3">
                    <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-sm font-medium">2363</span>
                  </td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="p-3 text-gray-600">Reference Books</td>
                  <td className="p-3">
                    <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-sm font-medium">Included</span>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {[
          ...
          { icon: "📱", title: "Digital Resources", desc: "Access to reference books, encyclopedias & e-content" },
          { icon: "📖", title: "Open Shelf System", desc: "Free access to books and resources" },
          { icon: "📰", title: "Newspapers & Journals", desc: "National & International journals available" },
          { icon: "🗺️", title: "Maps & Charts", desc: "Educational maps and charts for reference" },
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-gray-600">Phone: +91 89750 54114</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <span className="text-green-500">✉️</span>
              <span className="text-gray-600">Email: jaiganesh_bed@yahoo.com</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <span className="text-purple-500">📍</span>
              <span className="text-gray-600">Location: Campus-2, Narhe, Pune - 411041</span>
            </div>
          </div>
        </div>
      </div>
...
export default function Library() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
      <Helmet>
        <title>Library | Jai Ganesh College of Education - B.Ed</title>
      </Helmet>
      ...
      >
        ...
        <p className="text-gray-600 text-lg">Your gateway to knowledge and resources at Jai Ganesh College of Education - B.Ed</p>
      </motion.div>
