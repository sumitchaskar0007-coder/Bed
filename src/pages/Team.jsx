...
export default function Team() {
	return (
		<div className="container-responsive py-10">
			...
			{/* Staff list download - added per request */}
			<div className="mb-6 flex items-center justify-end">
				<a href="/assets/pdf/Staff%20List.pdf" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-blue-600 text-white rounded-lg">View Staff List</a>
				<a href="/assets/pdf/Staff%20List.pdf" download className="ml-3 px-4 py-2 border rounded-lg">Download</a>
			</div>
